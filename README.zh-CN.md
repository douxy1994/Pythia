<div align="center">
  ...
  **所有翻译服务，一个原生窗口——划词、截图、即翻。**
  ...
  [![Windows](https://img.shields.io/badge/Windows_x64-1.2.0-0078D4?logo=windows11&logoColor=white)](#windows)
...
<table>
  <tr>
    ...
    <td width="50%" align="center">
      ...
      <p><strong>原生 WinUI 3 · 当前版本 1.2.0</strong></p>
...
- Windows 1.2.0 安装包暂未进行 Authenticode 签名，可能触发 Microsoft Defender SmartScreen；安装前请核对 SHA-256。
...
- macOS 14 或更高版本、Apple silicon Mac、Xcode 27 beta 或更高版本。
...
当前 Windows 客户端仅支持 x64/AMD64，位于 [`Windows/Pythia.WinUI`](Windows/Pythia.WinUI/README.md)，使用 C# 14、.NET 10、WinUI 3、Windows App SDK、凭据管理器、UI Automation、Windows OCR、全局快捷键、托盘/启动集成和 Inno Setup；发布门禁会拒绝插件与私密材料。`Windows/Pythia.Windows` 仅保留为旧版兼容参考。
...
- Windows 1.2.0 以未做 Authenticode 签名的形式发布；签名留待后续版本，证书文件始终不得进入 Git。
...
Windows/Pythia.WinUI/    原生 WinUI 3 Windows 客户端
Windows/Pythia.Windows/  旧 Flutter/Win32 兼容参考
